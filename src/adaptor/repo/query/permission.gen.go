...
func newPermission(db *gorm.DB, opts ...gen.DOOption) permission {
	...
	_permission.PagePath = field.NewString(tableName, "page_path")
	_permission.ParentID = field.NewInt64(tableName, "parent_id")
	_permission.Status = field.NewInt32(tableName, "status")
	_permission.Sort = field.NewInt32(tableName, "sort")
	_permission.Desc = field.NewString(tableName, "desc")
	_permission.CreateAt = field.NewTime(tableName, "create_at")
	_permission.UpdateAt = field.NewTime(tableName, "update_at")
	_permission.UpdateBy = field.NewInt64(tableName, "update_by")
...
func (p *permission) updateTableName(table string) *permission {
	...
	p.PagePath = field.NewString(table, "page_path")
...
func (p *permission) fillFieldMap() {
	...
	p.fieldMap["page_path"] = p.PagePath
